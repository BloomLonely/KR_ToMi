...
from src.kr_story import StoryType, generate_story
from src.kr_world import World
...
def main(opt):
    ...
    for data_type in ["train", "val", "test"]:
        ...
        with open(stories_path, "w", encoding="utf-8") as f, open(trace_path, "w", encoding="utf-8") as trace_f, tqdm(
            total=N
        ) as pbar:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out-dir", "-o", default="data/korean")
